...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.view_count'
        db.add_column('location_location', 'view_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.view_count'
        db.delete_column('location_location', 'view_count')
