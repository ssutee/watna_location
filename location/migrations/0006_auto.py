...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field visitors on 'Location'
        db.create_table('location_location_visitors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm['location.location'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('location_location_visitors', ['location_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field visitors on 'Location'
        db.delete_table('location_location_visitors')
