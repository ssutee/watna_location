...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Picture.position'
        db.delete_column('location_picture', 'position')

        # Adding field 'Picture.order'
        db.add_column('location_picture', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Picture.position'
        db.add_column('location_picture', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Picture.order'
        db.delete_column('location_picture', 'order')
    ...
    models = {
        ...
        'location.picture': {
            'Meta': {'ordering': "('order', 'pk')", 'object_name': 'Picture'},
