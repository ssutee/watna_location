...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('location_location', 'contact_name')

        # Deleting field 'Location.email'
        db.delete_column('location_location', 'email')

        # Adding field 'Location.user'
        db.add_column('location_location', 'user',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Location.contact_name'
        raise RuntimeError("Cannot reverse this migration. 'Location.contact_name' and its values cannot be restored.")
        # Adding field 'Location.email'
        db.add_column('location_location', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Location.user'
        db.delete_column('location_location', 'user_id')
