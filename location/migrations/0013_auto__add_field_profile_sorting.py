...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.sorting'
        db.add_column('location_profile', 'sorting',
                      self.gf('django.db.models.fields.CharField')(default='entry', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.sorting'
        db.delete_column('location_profile', 'sorting')
