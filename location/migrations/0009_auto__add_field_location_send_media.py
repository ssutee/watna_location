...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.send_media'
        db.add_column('location_location', 'send_media',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.send_media'
        db.delete_column('location_location', 'send_media')
