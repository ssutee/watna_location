...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.other_skills'
        db.add_column('location_profile', 'other_skills',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.other_skills'
        db.delete_column('location_profile', 'other_skills')
