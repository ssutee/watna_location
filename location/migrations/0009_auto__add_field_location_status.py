...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('location_location', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='locations', null=True, to=orm['location.Status']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.status'
        db.delete_column('location_location', 'status_id')
