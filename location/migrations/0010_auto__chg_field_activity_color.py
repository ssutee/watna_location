...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.color'
        db.alter_column('location_activity', 'color', self.gf('location.models.ColorModelField')(max_length=7))

    def backwards(self, orm):

        # Changing field 'Activity.color'
        db.alter_column('location_activity', 'color', self.gf('django.db.models.fields.CharField')(max_length=7))
