...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Picture.position'
        db.alter_column('location_picture', 'position', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Picture.position'
        db.alter_column('location_picture', 'position', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'location.picture': {
            'Meta': {'ordering': "('position', 'pk')", 'object_name': 'Picture'},
            ...
            'position': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
