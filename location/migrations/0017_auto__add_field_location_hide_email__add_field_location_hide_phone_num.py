...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.hide_email'
        db.add_column('location_location', 'hide_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Location.hide_phone_number'
        db.add_column('location_location', 'hide_phone_number',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Location.hide_address'
        db.add_column('location_location', 'hide_address',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.hide_email'
        db.delete_column('location_location', 'hide_email')

        # Deleting field 'Location.hide_phone_number'
        db.delete_column('location_location', 'hide_phone_number')

        # Deleting field 'Location.hide_address'
        db.delete_column('location_location', 'hide_address')
