...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('location_location', 'organization',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Activity.priority'
        db.add_column('location_activity', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Activity.color'
        db.add_column('location_activity', 'color',
                      self.gf('django.db.models.fields.CharField')(default='#FF776B', max_length=7),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('location_location', 'organization')

        # Deleting field 'Activity.priority'
        db.delete_column('location_activity', 'priority')

        # Deleting field 'Activity.color'
        db.delete_column('location_activity', 'color')
    ...
    models = {
        ...
        'location.activity': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'default': "'#FF776B'", 'max_length': '7'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
