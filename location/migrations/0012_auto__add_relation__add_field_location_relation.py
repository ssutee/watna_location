...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.relation'
        db.add_column('location_location', 'relation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.Relation'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Location.relation'
        db.delete_column('location_location', 'relation_id')
    ...
    models = {
        ...
        'location.location': {
            ...
            'relation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['location.Relation']", 'null': 'True'}),
