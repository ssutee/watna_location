...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Picture.thumbnail'
        db.alter_column('location_picture', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Picture.thumbnail'
        db.alter_column('location_picture', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
