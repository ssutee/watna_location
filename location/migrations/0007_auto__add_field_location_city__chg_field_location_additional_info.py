...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('location_location', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


        # Changing field 'Location.additional_info'
        db.alter_column('location_location', 'additional_info', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Location.city'
        db.delete_column('location_location', 'city')


        # Changing field 'Location.additional_info'
        db.alter_column('location_location', 'additional_info', self.gf('django.db.models.fields.TextField')(default=''))
