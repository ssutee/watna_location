...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field vistors on 'Location'
        db.create_table('location_location_vistors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm['location.location'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('location_location_vistors', ['location_id', 'user_id'])

        # Removing M2M table for field vistors on 'Profile'
        db.delete_table('location_profile_vistors')


    def backwards(self, orm):
        # Removing M2M table for field vistors on 'Location'
        db.delete_table('location_location_vistors')

        # Adding M2M table for field vistors on 'Profile'
        db.create_table('location_profile_vistors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['location.profile'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('location_profile_vistors', ['profile_id', 'user_id'])
    ...
    models = {
        ...
        'location.location': {
            ...
            'vistors': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'users'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"})
        },
        'location.picture': {
