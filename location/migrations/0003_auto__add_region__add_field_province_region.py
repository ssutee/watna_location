...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('location_province', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='provinces', null=True, to=orm['location.Region']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('location_province', 'region_id')
